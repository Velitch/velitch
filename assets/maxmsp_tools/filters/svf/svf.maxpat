...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 955.0, 275.0, 75.0, 21.0 ],
					"text" : "BANDPASS",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 955.0, 275.0, 401.0, 134.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 955.0, 147.0, 45.0, 23.0 ],
					"text" : "0.9999"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 755.5, 147.0, 39.0, 23.0 ],
					"text" : "1000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 755.5, 116.0, 58.0, 23.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 602.0, 184.0, 54.0, 21.0 ],
					"text" : "SIGNAL",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1008.5, 184.0, 25.0, 21.0 ],
					"text" : "Q",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 807.5, 178.0, 84.0, 35.0 ],
					"text" : "CUTOFF\nFREQUENCY",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 955.0, 411.0, 51.0, 21.0 ],
					"text" : "NOTCH",
					"textcolor" : [ 0.996078431372549, 0.996078431372549, 0.996078431372549, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 556.0, 411.0, 70.0, 21.0 ],
					"text" : "LOWPASS",
					"textcolor" : [ 0.996078431372549, 0.996078431372549, 0.996078431372549, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 556.0, 275.0, 71.0, 21.0 ],
					"text" : "HIGHPASS",
					"textcolor" : [ 0.996078431372549, 0.996078431372549, 0.996078431372549, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 955.0, 403.0, 401.0, 134.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 556.0, 275.0, 401.0, 134.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 955.0, 184.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 755.5, 184.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 556.0, 184.0, 44.0, 23.0 ],
					"text" : "noise~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 556.0, 403.0, 401.0, 134.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 556.0, 221.0, 418.0, 23.0 ],
					"text" : "gen~ svf"
				}
...
, 			{
				"box" : 				{
					...
					"rendermode" : 0,
					"url" : "https://velitch.github.io/velitch/2021-10-19-tool_gen_svf/"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "svf.gendsp",
				"bootpath" : "D:/Git BN_Musica_Elettronica/IBN/COME-05-informatica-musicale-IBN/Filtri_gen/svf",
				"patcherrelativepath" : ".",
				"type" : "gDSP",
				"implicit" : 1
			}
