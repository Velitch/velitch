...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 849.0, 427.0, 89.0, 23.0 ],
					"text" : "1000., 1. 3000."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 849.0, 396.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 849.0, 457.0, 40.0, 23.0 ],
					"text" : "line"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 849.0, 371.0, 50.5, 23.0 ],
					"text" : "key 32"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 849.0, 217.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 723.0, 217.0, 44.0, 23.0 ],
					"text" : "noise~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 723.0, 308.0, 454.0, 180.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 723.0, 258.0, 145.0, 23.0 ],
					"text" : "gen~ onepole"
				}
...
, 			{
				"box" : 				{
					...
					"rendermode" : 0,
					"url" : "https://velitch.github.io/velitch/2021-10-19-tool_gen_onepole/"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "onepole.gendsp",
				"bootpath" : "D:/Git BN_Musica_Elettronica/IBN/COME-05-informatica-musicale-IBN/Filtri_gen/onepole",
				"patcherrelativepath" : ".",
				"type" : "gDSP",
				"implicit" : 1
			}
